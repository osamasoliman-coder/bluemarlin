...
<div class="loader_bg">
    <div class="loader">
        <!--
                      <h6 style="color: white;width: 250px;margin-right: 80px;font-size: 20px;letter-spacing: 4px" data-aos="zoom-in-up">
                      <span style="color: blue;font-size: 27px;">B</span>luemarlin
